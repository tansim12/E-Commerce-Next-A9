...
const CManageProducts = () => {
  ...
  const {
    ...
    isSuccess,
  } = useAdminFindAllProducts(page, pageSize, [
    ...params,
        ...
        <div className="overflow-x-scroll ">
          ...
          >
            <TableHeader>
              ...
              <TableColumn>Shop Logo</TableColumn>
              ...
              <TableBody>
                {shopData?.result?.map((pd: any) => (
                  <TableRow key={pd?.id}>
                    ...
                    <TableCell>{pd?.shop?.name || "N/A"}</TableCell>
                    <TableCell>
                      <Image
                        height={80}
                        width={80}
                        src={pd?.shop?.logo ? pd?.shop?.logo : ""}
                        alt="shop"
                        className="object-cover rounded"
                      />
                    </TableCell>
...
export default CManageProducts;
